...
<xsl:template match="library/desc|interface/desc|group/desc|code/desc|meth/desc|example/desc">
	<xsl:apply-templates/>
</xsl:template>
...
<xsl:template match="title/ident|desc/ident|th/ident|td/ident">
	<TT>
	<xsl:apply-templates/>
	</TT>
</xsl:template>
...
<xsl:template match="tt|p|i|b|font|ul|li|a|br">
	<xsl:copy-of select="."/>
</xsl:template>
